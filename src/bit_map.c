...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/04 17:27:00 by jinbkim           #+#    #+#             */
/*   Updated: 2021/02/10 06:31:38 by hyunkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

int		bitmap_info_header(t_image *mlx_img, int fd)
{
...
void	mir_verti_pixel(t_image *mlx_img, int line_cnt, int *e, int f)
{
	char	save;
	int		k;
...
int		data_to_bitmap(t_image *mlx_img, int fd)
{
	int i;
